    ...
    <main>
        ...
        <?php
            ...
            try
            {
                ...
                $consulta = $conexao->query("SELECT * FROM tabela_professor ORDER BY matricula DESC");
                ...
                while($campo = $consulta->fetch(PDO::FETCH_ASSOC))
                {
                    ...
                    echo "<td>{$campo['data_nascimento']}</td>";
                    echo "<td>{$campo['valor']}</td>";
					echo "<td><img src='fotos/{$campo['foto']}' width='50' height='50' style='border-radius: 20%;'></td>";
                    echo "</tr>";
