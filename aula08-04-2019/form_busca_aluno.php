...
<body>
    ...
    <main>
        ...
        <p><label>Digite o nome do aluno que deseja buscar:</label></p>
        ...
        <?php
            if(isset($_GET['buscar']))
            {
                ...
                try
                {
                    ...
                    $comando_sql = "SELECT * FROM tabela_aluno WHERE nome LIKE '%$valor%'";
                    ...
                    while($registro = $consulta->fetch(PDO::FETCH_ASSOC))
                    {
						print "	<tr>
									 ...
									 <td>{$registro['nome']}</td>
									 <td><img src='fotos_alunos/{$registro['foto']}' width='100' height='100' style='border-radius: 50px;'></td>
            ...
            else if(isset($_GET['excluir']))
            {
                ...
                $comando_sql = "DELETE FROM tabela_aluno WHERE matricula = :valor";
